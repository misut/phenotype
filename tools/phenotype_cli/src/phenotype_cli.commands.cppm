                    ...
                    },
                    {
                        ...
                        .options = {
                            ...
                            {.name = "expect",
                             ...
                             .repeatable = true,
                             .value_name = "kind:value",
                             .description = "Assert final state, such as density:dense, backdrop:high, material-count:9"},
                        },
                        .allow_positionals = false,
                        .examples = {
                            "phenotype drive glass-showcase --json --input density:dense --input backdrop:high",
                            "phenotype drive glass-showcase --script glass.drive --expect material-count:9 --json",
                        },
                    },
                },
                .allow_positionals = false,
