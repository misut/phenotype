                ...
                .subcommands = {
                    ...
                    },
                    {
                        ...
                        .options = {
                            ...
                            {.name = "scroll-bar-visibility",
                             .arity = cppx::cli::OptionArity::one,
                             .value_name = "auto|always|hidden",
                             .description = "App/user overlay scrollbar visibility"},
                        ...
                        .examples = {
                            ...
                            "phenotype theme resolve --font-scale 1.2 --scroll 1.5 --scroll-bar-visibility always --json",
                        },
                    },
                },
                .allow_positionals = false,
