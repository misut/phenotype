...
int main() {
    ...
    assert(contains_text(
        pressure_json,
        "\"executor\":{\"state\":\"fail\",\"bound_count\":3,\"pass_count\":2,\"fail_count\":1,\"zero_margin_count\":1,\"negative_margin_count\":1,\"zero_margin_sources\":[{\"key\":\"execution_stage_count_lte\",\"field\":\"execution_stage_count\"}],\"negative_margin_sources\":[{\"key\":\"draw_calls_gte\",\"field\":\"draw_calls\"}],\"tightest_bound_key\":\"upload_utilization_lte\",\"tightest_bound_field\":\"upload_utilization\",\"tightest_bound_margin\":0.9375,\"failed_keys\":[\"draw_calls_gte\"]}"));
    assert(contains_text(
        pressure_json,
        "\"resource\":{\"state\":\"tight\",\"bound_count\":2,\"pass_count\":2,\"fail_count\":0,\"zero_margin_count\":2,\"negative_margin_count\":0,\"zero_margin_sources\":[{\"key\":\"max_plan_sample_taps_lte\",\"field\":\"max_plan_sample_taps\"},{\"key\":\"require_bounded_texture_copy\",\"field\":\"unbounded_texture_copy\"}],\"negative_margin_sources\":[],\"tightest_bound_key\":\"max_plan_sample_taps_lte\",\"tightest_bound_field\":\"max_plan_sample_taps\",\"tightest_bound_margin\":0,\"failed_keys\":[]}"));
    assert(contains_text(
        pressure_json,
        "\"quality\":{\"state\":\"tight\",\"bound_count\":2,\"pass_count\":2,\"fail_count\":0,\"zero_margin_count\":2,\"negative_margin_count\":0,\"zero_margin_sources\":[{\"key\":\"max_blur_radius_lte\",\"field\":\"max_blur_radius\"},{\"key\":\"require_noise_allowed\",\"field\":\"noise_disabled\"}],\"negative_margin_sources\":[],\"tightest_bound_key\":\"require_noise_allowed\",\"tightest_bound_field\":\"noise_disabled\",\"tightest_bound_margin\":0,\"failed_keys\":[]}"));
    assert(
        verifier_bound_pressure_text(report)
        == "executor=fail,pass=2/3,fail=1,zero=1,negative=1,tightest=upload_utilization_lte,field=upload_utilization,tightest-margin=0.9375,zero-sources=(execution_stage_count_lte/execution_stage_count),negative-sources=(draw_calls_gte/draw_calls),failed=(draw_calls_gte); resource=tight,pass=2/2,fail=0,zero=2,negative=0,tightest=max_plan_sample_taps_lte,field=max_plan_sample_taps,tightest-margin=0,zero-sources=(max_plan_sample_taps_lte/max_plan_sample_taps, require_bounded_texture_copy/unbounded_texture_copy); quality=tight,pass=2/2,fail=0,zero=2,negative=0,tightest=require_noise_allowed,field=noise_disabled,tightest-margin=0,zero-sources=(max_blur_radius_lte/max_blur_radius, require_noise_allowed/noise_disabled)");
    ...
    assert(contains_text(
        failure_json,
        "\"bound_pressure\":{\"executor\":{\"state\":\"fail\",\"bound_count\":3,\"pass_count\":2,\"fail_count\":1,\"zero_margin_count\":1,\"negative_margin_count\":1,\"zero_margin_sources\":[{\"key\":\"execution_stage_count_lte\",\"field\":\"execution_stage_count\"}],\"negative_margin_sources\":[{\"key\":\"draw_calls_gte\",\"field\":\"draw_calls\"}],\"tightest_bound_key\":\"upload_utilization_lte\",\"tightest_bound_field\":\"upload_utilization\",\"tightest_bound_margin\":0.9375,\"failed_keys\":[\"draw_calls_gte\"]},\"resource\":{\"state\":\"tight\",\"bound_count\":2,\"pass_count\":2,\"fail_count\":0,\"zero_margin_count\":2,\"negative_margin_count\":0,\"zero_margin_sources\":[{\"key\":\"max_plan_sample_taps_lte\",\"field\":\"max_plan_sample_taps\"},{\"key\":\"require_bounded_texture_copy\",\"field\":\"unbounded_texture_copy\"}],\"negative_margin_sources\":[],\"tightest_bound_key\":\"max_plan_sample_taps_lte\",\"tightest_bound_field\":\"max_plan_sample_taps\",\"tightest_bound_margin\":0,\"failed_keys\":[]},\"quality\":{\"state\":\"tight\",\"bound_count\":2,\"pass_count\":2,\"fail_count\":0,\"zero_margin_count\":2,\"negative_margin_count\":0,\"zero_margin_sources\":[{\"key\":\"max_blur_radius_lte\",\"field\":\"max_blur_radius\"},{\"key\":\"require_noise_allowed\",\"field\":\"noise_disabled\"}],\"negative_margin_sources\":[],\"tightest_bound_key\":\"require_noise_allowed\",\"tightest_bound_field\":\"noise_disabled\",\"tightest_bound_margin\":0,\"failed_keys\":[]}}"));
    assert(contains_text(
        failure_json,
