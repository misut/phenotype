...
- `examples/file_explorer_desktop` and `examples/file_explorer_mobile` are
  ...
  material container ids/spacing, stage-capacity/drop counters, and bounded
  resource budgets.
- `tools/verify_artifact_bundle.py` validates the common schema, semantic tree,
  ...
  capacity and dropped-stage checks, material resource bounds, failure
